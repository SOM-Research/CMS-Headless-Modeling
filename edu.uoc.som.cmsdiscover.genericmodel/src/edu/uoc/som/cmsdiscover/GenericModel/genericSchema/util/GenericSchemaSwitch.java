 ...
 * @generated
 */
public class GenericSchemaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GenericSchemaPackage.COMMENT: {
				Comment comment = (Comment)theEObject;
				T result = caseComment(comment);
				if (result == null) result = caseContentEntity(comment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericSchemaPackage.FILE: {
				File file = (File)theEObject;
				T result = caseFile(file);
				if (result == null) result = caseContentEntity(file);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericSchemaPackage.MEDIA: {
				Media media = (Media)theEObject;
				T result = caseMedia(media);
				if (result == null) result = caseContentEntity(media);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericSchemaPackage.BLOCK: {
				Block block = (Block)theEObject;
				T result = caseBlock(block);
				if (result == null) result = caseContentEntity(block);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericSchemaPackage.CONTENT_TYPE: {
				ContentType contentType = (ContentType)theEObject;
				T result = caseContentType(contentType);
				if (result == null) result = caseContentEntity(contentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericSchemaPackage.TAXONOMY: {
				Taxonomy taxonomy = (Taxonomy)theEObject;
				T result = caseTaxonomy(taxonomy);
				if (result == null) result = caseContentEntity(taxonomy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
