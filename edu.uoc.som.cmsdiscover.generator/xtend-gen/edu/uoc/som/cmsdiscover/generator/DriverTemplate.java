...
public class DriverTemplate {
  ...
  public CharSequence addGetSearchQuery() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return new SearchQueryBuilder();");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    return _builder;
  ...
  public CharSequence addSingleGetter() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("JsonElement answer = resourceRequest(resourceRoute+\"/\"+Id,\"GET\", new SearchQueryBuilder().build());");
    _builder.newLine();
    _builder.append("\t\t");
  ...
  public CharSequence addDrupalRequester() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("String filters = \"\";");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("for (Entry<String, String> entry : searchQuery.filterQuery.entrySet()) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("try {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("String filter = URLEncoder.encode(entry.getValue(), StandardCharsets.UTF_8.toString());");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("filters = filters + \"&filter[\"+entry.getKey()+\"]=\"+filter;");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("String sorters = \"\";");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("for (Entry<String, String> entry : searchQuery.sorterQuery.entrySet()) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if(entry.getValue().contains(\"ASC\")) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("sorters = sorters + \"&sort=\"+entry.getKey();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("String embeds = \"\";");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("for (Entry<String, String> entry : searchQuery.embedQuery.entrySet()) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("embeds = \"&include=\"+entry.getValue();");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("String pagination = \"\";");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("for (Entry<Integer, Integer> entry : searchQuery.pagination.entrySet()) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if ((entry.getKey() != 0) && (entry.getValue() != 0)) pagination = \"&page[offset]=\"+entry.getKey()+\"&page[limit]=\"+entry.getValue();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if (entry.getKey() != 0) pagination = \"&page[offset]=\"+entry.getKey();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if (entry.getValue() != 0) pagination = \"&page[limit]=\"+entry.getValue();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("HttpRequest request = HttpRequest.newBuilder().uri(URI.create(this.cmsUrl + resource +\"?\"+ filters + pagination + sorters + embeds))");
    _builder.newLine();
    _builder.append("\t\t");
